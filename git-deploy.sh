...
# in a git workflow. (This is not a part of the book). The script will stop if 
# an error occurs. To make this into a command place this script in your `/usr/bin` folder. 
